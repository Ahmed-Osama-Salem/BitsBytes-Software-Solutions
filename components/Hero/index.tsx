        ...
        <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
          <div className="md:w-1/2">
            <h4 className="mb-4.5 text-lg font-medium text-black dark:text-white">
              🚀 BitsBytes – Your Digital Innovation Partner
            </h4>
            ...
            <p className="text-base text-black dark:text-white">
              We specialize in building scalable web and mobile applications
              tailored to your business needs. From startups to enterprises —
              our team delivers high-quality digital solutions using Next.js,
              React Native, and modern stacks.
            </p>
            ...
            <div className="mt-10">
              ...
              <p className="mt-5 text-black dark:text-white">
                Let’s bring your vision to life — no upfront payment needed.
              </p>
            </div>
          </div>
