        ...
        <div className="max-w-c-1235 mx-auto overflow-hidden px-4 md:px-8 2xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                Suiiz is a marketplace mobile application that allows users to
                buy and sell products quickly and easily. BitsBytes handled the
                complete mobile development and backend infrastructure —
                including authentication, chat, notifications, and listing
                management.
              </p>
              <div>
                <a
